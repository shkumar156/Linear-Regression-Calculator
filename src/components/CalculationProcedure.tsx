  ...
  return (
    <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-8 rounded-2xl shadow-xl border border-purple-100">
      <h3 className="text-2xl font-bold text-gray-800 mb-6 flex items-center">
        <Calculator className="mr-3 text-purple-600" size={28} />
      ...
      <div className="space-y-8">
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
          <h4 className="text-lg font-bold text-gray-700 mb-4 text-center bg-blue-50 py-2 rounded-lg">
            Step 1: Calculate Required Sums
          </h4>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6 text-center">
            <div className="bg-blue-50 p-4 rounded-lg">
              <p className="font-semibold text-gray-600 text-sm">Number of points</p>
              <p className="text-xl font-bold text-blue-600">n = {n}</p>
            </div>
            <div className="bg-green-50 p-4 rounded-lg">
              <p className="font-semibold text-gray-600 text-sm">Sum of X</p>
              <p className="text-xl font-bold text-green-600">Σx = {sumX}</p>
            </div>
            <div className="bg-orange-50 p-4 rounded-lg">
              <p className="font-semibold text-gray-600 text-sm">Sum of Y</p>
              <p className="text-xl font-bold text-orange-600">Σy = {sumY}</p>
            </div>
            <div className="bg-purple-50 p-4 rounded-lg">
              <p className="font-semibold text-gray-600 text-sm">Sum of XY</p>
              <p className="text-xl font-bold text-purple-600">Σxy = {sumXY}</p>
            </div>
            <div className="bg-red-50 p-4 rounded-lg">
              <p className="font-semibold text-gray-600 text-sm">Sum of X²</p>
              <p className="text-xl font-bold text-red-600">Σx² = {sumXSquared}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
          <h4 className="text-lg font-bold text-gray-700 mb-4 text-center bg-green-50 py-2 rounded-lg">
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
          <h4 className="text-lg font-bold text-gray-700 mb-4 text-center bg-orange-50 py-2 rounded-lg">
